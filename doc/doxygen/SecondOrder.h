...
\note This module is released under the terms of the <a href="http://www.gnu.org/licenses/gpl-2.0.html">GNU General
...
Experimenting with these different algorithm for solving the 1-contact problem may be done by specifying the
local_soc_solver::Strategy template argument of the SOCLaw class.
