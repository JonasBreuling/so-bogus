...
struct CompoundMultiplier {  // colwise compound not transposed or rowwise transposed
  ...
  static void multiply(const CompoundBlockMatrix<!DoTranspose, MatrixT1, MatrixT2>& mat, const RhsT& rhs, ResT& res,
    ...
    const Segmenter<internal::DYNAMIC, const RhsT,
...
struct CompoundMultiplier<false, DoTranspose> {  // colwise compound transposed or rowwise not transposed
...
CompoundBlockMatrix<ColWise, MatrixT1, MatrixT2>::CompoundBlockMatrix(const IterableBlockObject<MatrixT1>& first,
...
void CompoundBlockMatrix<ColWise, MatrixT1, MatrixT2>::multiply(const RhsT& rhs, ResT& res, Scalar alpha,
                                                                Scalar beta) const {
  mv_impl::CompoundMultiplier<!DoTranspose, DoTranspose>::multiply(*this, rhs, res, alpha, beta);
}

template <bool ColWise, typename MatrixT1, typename MatrixT2>
template <bool DoTranspose, typename RhsT, typename ResT, typename PreOp>
void CompoundBlockMatrix<ColWise, MatrixT1, MatrixT2>::rowMultiplyPrecompose(const Index row, const RhsT& rhs,
                                                                             ResT& res, const PreOp& op) const {
  mv_impl::CompoundMultiplier<!DoTranspose, DoTranspose>::rowMultiplyPrecompose(*this, row, rhs, res, op);
}

template <bool ColWise, typename MatrixT1, typename MatrixT2>
template <bool DoTranspose, typename RhsT, typename ResT, typename PostOp>
void CompoundBlockMatrix<ColWise, MatrixT1, MatrixT2>::colMultiplyPostcompose(const Index col, const RhsT& rhs,
                                                                              ResT& res, const PostOp& op) const {
  mv_impl::CompoundMultiplier<!DoTranspose, DoTranspose>::colMultiplyPostcompose(*this, col, rhs, res, op);
}
...
CompoundBlockMatrix<false, MatrixT1, MatrixT2>::CompoundBlockMatrix(const IterableBlockObject<MatrixT1>& first,
                                                                    const IterableBlockObject<MatrixT2>& second)
    : m_first(first), m_second(second) {
  // Macro offsets
  m_compoundOffsets[0] = 0;
...
template <typename MatrixT1, typename MatrixT2>
template <bool DoTranspose, typename RhsT, typename ResT>
void CompoundBlockMatrix<false, MatrixT1, MatrixT2>::multiply(const RhsT& rhs, ResT& res, Scalar alpha,
                                                              Scalar beta) const {
  mv_impl::CompoundMultiplier<DoTranspose, DoTranspose>::multiply(*this, rhs, res, alpha, beta);
}
...
template <typename MatrixT1, typename MatrixT2>
template <bool DoTranspose, typename RhsT, typename ResT, typename PreOp>
void CompoundBlockMatrix<false, MatrixT1, MatrixT2>::rowMultiplyPrecompose(const Index row, const RhsT& rhs, ResT& res,
...
template <typename MatrixT1, typename MatrixT2>
template <bool DoTranspose, typename RhsT, typename ResT, typename PostOp>
void CompoundBlockMatrix<false, MatrixT1, MatrixT2>::colMultiplyPostcompose(const Index col, const RhsT& rhs, ResT& res,
