...
inline void serialize(Archive& ar, bogus::SparseBlockIndex<false, Index, BlockPtr>& index,
...
template <typename Archive, typename Index, typename BlockPtr>
inline void serialize(Archive& ar, bogus::SparseBlockIndex<true, Index, BlockPtr>& index,
                      const unsigned int file_version) {
  BlockPtr dummy_base;
...
void SparseBlockMatrixBase<Derived>::serialize(Archive& ar, const unsigned int file_version) {
