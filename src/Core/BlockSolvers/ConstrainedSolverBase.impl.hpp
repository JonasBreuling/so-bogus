...
typename ConstrainedSolverBase<Derived, BlockMatrixType>::Scalar ConstrainedSolverBase<Derived, BlockMatrixType>::eval(
    const NSLaw &law, const ResT &y, const RhsT &x) const {
...
void estimate_row_scaling(const BlockObjectBase<Derived> &, typename BlockObjectBase<Derived>::Scalar *) {}
...
void ConstrainedSolverBase<Derived, BlockMatrixType>::projectOnConstraints(const NSLaw &law, VectorT &x) const {
  Segmenter<NSLaw::dimension, VectorT, typename BlockMatrixType::Index> xSegmenter(x, m_matrix->rowOffsets());
...
template <typename Derived, typename BlockMatrixType>
template <typename NSLaw, typename RhsT, typename ResT>
void ConstrainedSolverBase<Derived, BlockMatrixType>::dualityCOV(const NSLaw &law, const RhsT &u, ResT &s) const {
  const Segmenter<NSLaw::dimension, const RhsT, typename BlockMatrixType::Index> uSegmenter(u, m_matrix->rowOffsets());
  Segmenter<NSLaw::dimension, ResT, typename BlockMatrixType::Index> sSegmenter(s, m_matrix->rowOffsets());
