...
GaussSeidelBase<GaussSeidelImpl, BlockMatrixType>::evalAndKeepBest(const NSLaw &law, const ResT &x,
...
bool GaussSeidelBase<GaussSeidelImpl, BlockMatrixType>::tryZero(const NSLaw &law, const RhsT &b, ResT &x,
                                                                typename GlobalProblemTraits::DynVector &x_best,
                                                                Scalar &err_best) const {
  x.setZero();
