...
inline void load(Archive& ar, Eigen::Matrix<_Scalar, _Rows, _Cols, _Options, _MaxRows, _MaxCols>& matrix,
...
template <typename Archive, typename _Scalar, int _Rows, int _Cols, int _Options, int _MaxRows, int _MaxCols>
inline void save(Archive& ar, const Eigen::Matrix<_Scalar, _Rows, _Cols, _Options, _MaxRows, _MaxCols>& matrix,
                 const unsigned int file_version) {
  (void)file_version;
  ar& make_array(matrix.data(), matrix.size());
}
...
inline void load(Archive& ar, Eigen::Matrix<_Scalar, Eigen::Dynamic, _Cols, _Options, _MaxRows, _MaxCols>& matrix,
                 const unsigned int file_version) {
  (void)file_version;
  int rows;
  ar & rows;
...
template <typename Archive, typename _Scalar, int _Cols, int _Options, int _MaxRows, int _MaxCols>
inline void save(Archive& ar, const Eigen::Matrix<_Scalar, Eigen::Dynamic, _Cols, _Options, _MaxRows, _MaxCols>& matrix,
                 const unsigned int file_version) {
  (void)file_version;
...
inline void load(Archive& ar, Eigen::Matrix<_Scalar, _Rows, Eigen::Dynamic, _Options, _MaxRows, _MaxCols>& matrix,
                 const unsigned int file_version) {
  (void)file_version;
  int cols;
  ar & cols;
...
template <typename Archive, typename _Scalar, int _Rows, int _Options, int _MaxRows, int _MaxCols>
inline void save(Archive& ar, const Eigen::Matrix<_Scalar, _Rows, Eigen::Dynamic, _Options, _MaxRows, _MaxCols>& matrix,
                 const unsigned int file_version) {
  (void)file_version;
...
template <typename Archive, typename _Scalar, int _Rows, int _Cols, int _Options, int _MaxRows, int _MaxCols>
inline void serialize(Archive& ar, Eigen::Matrix<_Scalar, _Rows, _Cols, _Options, _MaxRows, _MaxCols>& matrix,
                      const unsigned int file_version) {
  split_free(ar, matrix, file_version);
}

template <typename Archive, typename _Scalar, int _Options, typename _Index>
inline void load(Archive& ar, Eigen::SparseMatrix<_Scalar, _Options, _Index>& matrix, const unsigned int file_version) {
  (void)file_version;
  _Index rows, cols;
  unsigned nnz;
  ar & rows;
...
template <typename Archive, typename _Scalar, int _Options, typename _Index>
inline void save(Archive& ar, const Eigen::SparseMatrix<_Scalar, _Options, _Index>& matrix,
                 const unsigned int file_version) {
  (void)file_version;
...
template <typename Archive, typename _Scalar, int _Options, typename _Index>
inline void serialize(Archive& ar, Eigen::SparseMatrix<_Scalar, _Options, _Index>& matrix,
                      const unsigned int file_version) {
  split_free(ar, matrix, file_version);
}
