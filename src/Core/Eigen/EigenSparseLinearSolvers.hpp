...
template <typename Derived, typename FactType>
struct EigenSparseFactorization : public Factorization<Eigen::SparseMatrixBase<Derived>, FactType> {
...
struct LinearSolverTraits<LU<Eigen::SparseMatrixBase<Derived>>>
    : public LinearSolverTraits<
          Factorization<Eigen::SparseMatrixBase<Derived>, Eigen::SparseLU<Derived, Eigen::COLAMDOrdering<int>>>> {};
