...
static typename WType::Scalar solveCadoux(const WType& W, const typename WType::Scalar* b,
                                          ...
                                          ConstrainedSolverBase<Method, MatrixT>& minimizer, typename WType::Scalar* r,
...
template <unsigned Dimension, typename WType, typename Method, typename MatrixT>
static double solveCadouxVel(const WType& W, const typename WType::Scalar* b, const typename WType::Scalar* mu,
                             ConstrainedSolverBase<Method, MatrixT>& minimizer, typename WType::Scalar* u,
                             const unsigned cadouxIterations,
                             const Signal<unsigned, typename WType::Scalar>* callback = nullptr,
                             const typename WType::Scalar tolTighten = 1.e-1) {
  // Wu + b = r
