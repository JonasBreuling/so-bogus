...
TEST(Krylov, MultipleRhs) {
  ...
  A << 1044, -167, -1016, -735, 329, -1278, -454, 1273, -963, -651, 631, -1409, 1633, 1989, -596, -493, -969, 92, 1949,
      ...
      28, 1801, 1417, 1951, -25, 1194, -608, -1555, 304, -1320, 1022, 1881, 1795, 1535, 22, 1037, -302, -339, -551, 478,
      -1784, 1826, -1543, 84, -1653, 1752, 1786, 945, 221, -1767, 347, 1237, 1260, 1259, 774, -1990, 1899, 607, -1085,
      -566, -1454, 771, -1668, -869, 648, -864, -366, -1188, 1193, -98, 1766, 1381, -73, 1426, -1462, -426, -367, 906,
      1747, -1946, -651, 1336, -263;
  ...
  res.setZero();
  ri.setMethodName("GMRES");
  err = bogus::krylov::solvers::GMRES<Block>(A, 10).parallelizeRhs(true).solve(rhs, res);
  EXPECT_GT(1.e-15, err);
  EXPECT_GT(1.e-15, (A * res - rhs).squaredNorm());
