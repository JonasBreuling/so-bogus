...
TEST(Polynomial, SOQPQuartic) {
  Eigen::Matrix3d W;
  W << 0.01344, -9.421e-07, 0.001486, -9.421e-07, 0.1061, 0.0001733, 0.001486, 0.0001733, 0.001442;
  Eigen::Vector3d b;
  ...
  double res =
      bogus::LocalSOCSolver<3, double, false, bogus::local_soc_solver::PureEnumerative>::solve(W, b, r, mu, 1.e-12, 1);
